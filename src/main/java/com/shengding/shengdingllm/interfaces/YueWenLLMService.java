...
//
//            // 创建会话
//        JSONObject chatContext = createChatContext(assistantChatParams.getMessageId());
//
//
//
...
//                .url(BASE_URL + "https://yuewen.cn/api/proto.chat.v1.ChatMessageService/SendMessageStream")
//                .headers(headers)
//                .post(body);
