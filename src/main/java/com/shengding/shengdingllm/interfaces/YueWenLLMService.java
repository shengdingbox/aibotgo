...
//const RETRY_DELAY = 5000;
    ...
    private Map<String, String> getAuthHeader() {
        ...
        String deviceId = access_token.split("@")[0];
        ...
        pairs.put("Cookie", "Oasis-Token=" + token);
        pairs.put("Referer", "https://yuewen.cn/chats/new");
        pairs.put("Oasis-Webid", deviceId);
        return pairs;
    }
    ...
    public void requestToken() {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            String refreshToken = refreshTokenRaw.getString("raw");
            access_token = access_token.split("@")[0] + "@" + accessToken + "..." + refreshToken;
...
//      : [];
        ...
        // 创建会话
        JSONObject chatContext = createChatContext(null);
        JSONObject jsonObject = new JSONObject();
        //u{"chatId":"146136457939222528","messageInfo":{"text":"nihao1","author":{"role":"user"}},"messageMode":"SEND_MESSAGE"}
        jsonObject.put("chatId", chatContext.getString("chatId"));
        JSONObject message = new JSONObject();
        message.put("text", "你好");
        message.put("author", new JSONObject().put("role", "user"));
        jsonObject.put("messageInfo", message);
        jsonObject.put("messageMode", "SEND_MESSAGE");
        RequestBody body = RequestBody.create("u"+jsonObject.toJSONString().getBytes(), MediaType.parse("application/connect+json"));
        Headers.Builder builder = new Headers.Builder();
        getAuthHeader().forEach(builder::add);
        Headers headers = builder.build();
        Request.Builder post = new Request.Builder()
                .url(BASE_URL + "/proto.chat.v1.ChatMessageService/SendMessageStream")
                .headers(headers)
                .addHeader("Content-Type", "application/connect+json")
                .post(body);
...
//    });
    ...
    @Override
    protected JSONObject createChatContext(String messageId) {
        JSONObject context = new JSONObject();
        checkAvailability();
        requestToken();
        if (StringUtils.isBlank(messageId)) {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("chatName", "新话题");
            Request.Builder post = new Request.Builder()
                    .url(BASE_URL + "/proto.chat.v1.ChatService/CreateChat")
    ...
    public static void main(String[] args) {
        ...
        yueWenLLMService.setAccess_token("fcd05478c979787b8bab09e02658f315da7e25e2@eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY3RpdmF0ZWQiOnRydWUsImFnZSI6NiwiYmFuZWQiOmZhbHNlLCJjcmVhdGVfYXQiOjE3MjYyOTM5ODAsImV4cCI6MTcyNjI5NTc4MCwibW9kZSI6Miwib2FzaXNfaWQiOjE0NTc3NTY0MjYzMjQ2MjMzNiwidmVyc2lvbiI6Mn0.LjjM7voat5Gemldhl1OBVDHNfi3E-qJ97xxv5MoM-nk...eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHBfaWQiOjEwMjAwLCJkZXZpY2VfaWQiOiJmY2QwNTQ3OGM5Nzk3ODdiOGJhYjA5ZTAyNjU4ZjMxNWRhN2UyNWUyIiwiZXhwIjoxNzI4ODAxMTIyLCJvYXNpc19pZCI6MTQ1Nzc1NjQyNjMyNDYyMzM2LCJwbGF0Zm9ybSI6IndlYiIsInZlcnNpb24iOjJ9.OZ6NE7US1Ri_Kruey0Buk_9w-UZLevLJUWqtW9QD3yE");
        yueWenLLMService.sendPrompt(null, null, null);
    }
}
